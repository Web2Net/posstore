...
if($tag_data["level"]==1){
ShopTag::Event1($event,MOD_TAG_TABLE,$id);
}
ShopTag::Event2($event,MOD_TAG_TABLE,$id);
}
*/	
$tag_list1=ShopTag::tagListIdData($level=1);
$tag_list2=ShopTag::tagListIdData($level=2);
