...
{
$upload_path="/image/shop/item/tmp/";
...
//header("Location: /cms/shop/magic/crop.php?img=".$upload_path.$uploadfile."&size=740x480");

header("Location: /cms/shop/magic/load_prod_image.php?ext=crop&img=".$upload_path.$uploadfile."&size=740x480");    
...
GD::imageResize(getenv("DOCUMENT_ROOT").$medimg,getenv("DOCUMENT_ROOT").$bigimg,421,273,90);
GD::imageResize(getenv("DOCUMENT_ROOT").$smallimg,getenv("DOCUMENT_ROOT").$bigimg,100,65,90);	
